...
namespace PasaLife.Migrations
{
    ...
    [Migration("20211214133309_AddSeo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PasaLife.Models.HomeCarousel", b =>
                {
                    ...
                    b.Property<int>("HomeCarouselSeoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PasaLife.Models.Award", b =>
                {
                    b.HasOne("PasaLife.Models.AwardSeo", "AwardSeo")
                        .WithMany("Awards")
                        .HasForeignKey("AwardSeoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AwardSeo");
                });
            ...
            modelBuilder.Entity("PasaLife.Models.HomeCarousel", b =>
                {
                    b.HasOne("PasaLife.Models.HomeCarouselSeo", "HomeCarouselSeo")
                        .WithMany("HomeCarousels")
                        .HasForeignKey("HomeCarouselSeoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("HomeCarouselSeo");
                });
